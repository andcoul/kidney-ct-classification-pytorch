...
from kidneyCtClassifier.components.base_model import Net as RCAN
from kidneyCtClassifier.utils.evaluation import psnr2, ssim
import numpy as np
import argparse
import os
from kidneyCtClassifier.utils import common
...
parser.add_argument(
    "--model", default='../logs/kidneyCtClassifier/Exp19_nFr7_batch64_k20_l5Res12_m10_ecan_lab_dpw3_no_att/base_model.pth.tar', type=str,
    help="checkpoint")
